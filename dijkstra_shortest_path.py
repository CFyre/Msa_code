...
def dijkstra(graph, start):
    ...
    while tentative:
        ...
        #add lowest cost nodes to confirmed dictionary and update next
        ...
        for node, distance in graph[next].items():
            ...
            #if the neighbor is not in the tentative, add to tentative.
            #If neighbor in ttentative, update cost if necessary
